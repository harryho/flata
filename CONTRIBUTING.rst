...
2. Fork `the repository <https://github.com/harryho/pseudb/>`_ on GitHub,
...
Philosophy of PseuDB
********************

PseuDB aims to be simple and fun to use. Therefore two key values are simplicity
...
In general the PseuDB source should always follow `PEP 8 <http://legacy.python.org/dev/peps/pep-0008/>`_.
...
PseuDB follows the `SemVer versioning guidelines <http://semver.org/>`_.
